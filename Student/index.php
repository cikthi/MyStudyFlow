...
function updateTaskTimes() {
  ...
  // Go through each due-display
  document.querySelectorAll(".due-display").forEach(display => {
    const dueSpan = display.querySelector(".due-date");
    const nowSpan = display.querySelector(".now-time");

    // Show current time live
    nowSpan.innerText = now.toLocaleString();

    // Show due date (from data-due)
    if (dueSpan.dataset.due) {
      const dueDate = new Date(dueSpan.dataset.due);
      dueSpan.innerText = dueDate.toLocaleString();
...
<div id="myLists">
	<div id="to-do">
		...
		<ul id="ul-todo" class="section" ondrop="drop(event, this)" ondragover="allowDrop(event)" ondragenter="dragEnter(event)" ondragleave="dragLeave(event)">
			<li id="li-0003" draggable="true" ondragstart="drag(event)" ontouchstart="drag(event)" class="sample"><span class="txt"> </span><input type="datetime-local" class="setDue">
<span class="dueTimer"></span>
			<span class="idTask">0003</span><a class="up" href="#"></a><a class="down" href="#"></a><a class="delete" onclick="delTask(event, this.parentNode)" href="#"></a></li>
			
		</ul>
	</div>
	<div id="work-in">
		<h3>Pending <span></span></h3>
		<ul id="ul-working" class="section" ondrop="drop(event, this)" ondragover="allowDrop(event)" ondragenter="dragEnter(event)" ondragleave="dragLeave(event)">
			<li id="li-0004" draggable="true" ondragstart="drag(event)" ontouchstart="drag(event)" class="sample"><span class="txt">Add capability to reorder the tasks inside a list (only with arrows right now).</span><input type="datetime-local" class="setDue">
<span class="dueTimer"></span>
<span class="idTask">0004</span><a class="up" href="#"></a><a class="down" href="#"></a><a class="delete" onclick="delTask(event, this.parentNode)" href="#"></a></li>
	...
	<div id="do-ne">
		...
		<ul id="ul-done" class="section" ondrop="drop(event, this)" ondragover="allowDrop(event)" ondragenter="dragEnter(event)" ondragleave="dragLeave(event)">
			<li id="li-0001" draggable="true" ondragstart="drag(event)" ontouchstart="drag(event)" class="sample"><span class="txt">Publish "Josetxu Kanban Board" on Codepen.</span><input type="datetime-local" class="setDue">
<span class="dueTimer"></span>
<span class="idTask">0001</span><a class="up" href="#"></a><a class="down" href="#"></a><a class="delete" onclick="delTask(event, this.parentNode)" href="#"></a></li>
